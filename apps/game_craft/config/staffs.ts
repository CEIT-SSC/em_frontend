  ...
  const scientificTeam: StaffTeam = {
    ...
    teamMembers: [
      ...
      },
      {
        ...
        telegramUrl: "",
        linkedinUrl:
          "https://www.linkedin.com/in/mahdieh-tahami?trk=contact-info",
        githubUrl: "",
      },
      {
  ...
  const marketingTeam: StaffTeam = {
    ...
    teamMembers: [
      ...
      },
      {
        ...
        linkedinUrl:
          "https://www.linkedin.com/in/alireza-yousefpour-98492b24b/",
    ...
    teamMembers: [
      {
        ...
        githubUrl: "https://github.com/asal-jlz",
        linkedinUrl:
          "https://www.linkedin.com/in/asal-jlz/?originalSubdomain=ir",
        telegramUrl: "https://t.me/lost_butterfly7",
      },
      {
        imageUrl: "/images/2025/staffs/ShadiYousefabadi.jpg",
