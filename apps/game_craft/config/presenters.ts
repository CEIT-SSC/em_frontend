import type { StaffMember } from "./staffs";

export const presenters: StaffMember[] = [
  {
    imageUrl: "/images/2026/presenters/Farkhonde.jpg",
    name: "خسرو فرخنده",
    role: "مدرس گیم‌دیزاین",
  },
  {
    imageUrl: "/images/2026/presenters/Sanatjou.jpg",
    name: "احمدرضا صنعت جو",
    role: "متولد ۱۳۷۸ هستم. لیسانس مهندسی کامپیوتر رو در دانشگاه علم و صنعت خوندم و از همون دانشگاه شروع به فعالیت در بازیسازی کردم. درحال حاضر برای ۳ سال در استودیو بلک کیوب روی بازی های کنسول و PC کار میکنم",
  },
  {
    imageUrl: "/images/2026/presenters/Golpayegani.jpg",
    name: "Mina Golpayegani",
    role: "Full-stack game developer with 15 odd years of working experience in the computer engineering and games industry.",
  },
  {
    imageUrl: "/images/2026/presenters/ahh.jpeg",
    name: "Amirreza Heidarhosseini",
  ...
  },
  {
    ...
    name: "Amin Montazeri",
    role: "A Multiplayer Level Designer with over 5 years of experience",
  },
  {
    imageUrl: "/images/2026/presenters/Dehghan.jpg",
    name: "Firooz dehghan",
    role: "Gamer, Game Designer",
  },
  {
    imageUrl: "/images/2026/presenters/Taringo.jpg",
    name: "Alireza Taringo",
  ...
  {
    imageUrl: "/images/2026/presenters/Jafary.jpg",
    name: "Hojjat Jafary",
    role: "Senior Software Engineer, Technical Director, Dead Mage Game Studio, June 2011 – October 2024; CTO, Sharif AI Research Center, Feb 2025 - now; Technical Director, Cando Game Studio, May 2025 - now (Part time)",
  },
  {
  ...
  },
  {
    ...
    name: "علیرضا اسدی",
    role: "هم‌بنیان گذار و مدیر ارشد فناوری در استودیوی بازی‌سازی Exir Games، در حال توسعه نسل آینده بازی های واقعیت ترکیبی (MR) در فنلاند",
  },
  {
    imageUrl: "/images/2026/presenters/Peyvasteh.jpg",
    name: "Parsa Peyvasteh",
    role: "پارسا پیوسته، انیماتور ارشد شرکت Supermassive Games، با سابقه فعالیت در صنعت بازی‌سازی و جلوه های ویژه فیلم با تخصص در زمینه انیمیشن‌ Gameplay وCinematic، با رویکرد Keyframe و Motion Capture است. در پروژه‌هایی همچون Little Nightmares III و The Casting of Frank Stone و Brothers: A Tale of Two Sons Remake فعالیت داشته و پیش از آن نیز در چندین پروژه سینمایی و تلویزیونی داخلی و بین المللی همکاری کرده. فارغ‌التحصیل ارشد معماری از دانشگاه هنر ایران (تهران).",
  },
  {
    imageUrl: "/images/2026/presenters/Behfarrad.jpg",
    name: "محمد مهدی بهفرراد",
    role: "مدیر عامل استودیو بازی سازی مدریک",
  },
  {
    imageUrl: "/images/2026/presenters/Azad.jpg",
    name: "حمزه آزاد",
    role: "مدیرعامل شرکت بازی سازان جوان از سال ۱۳۹۲، مدیرعامل شرکت میوگیمز در ترکیه و قطر از سال ۲۰۲۰، سازنده بیش از ۱۰۰ عنوان بازی رایانه ای، موبایلی و تحت وب، دبیر جشنواره بازیسازان مستقل ایران",
  },
  {
    imageUrl: "/images/2026/presenters/Zehtabi.jpg",
    name: "محمد زهتابی",
    role: "مدیرعامل استودیو پاییزان و رئیس کمیسیون بازی ها و سرگرمی های سازمان نصر",
  },
  {
    imageUrl: "/images/2026/presenters/Jalalnezhad.jpg",
    name: "سامان جلال‌نژاد",
    role: "سامان جلال‌نژاد فعال صنعت بازی با بیش از ۱۴ سال تجربه در حوزه بازی‌های رایانه‌ای است. او سابقه فعالیت در تولید و نشر بازی، مدیریت محصول، هوش تجاری (BI) و داده در بیش از ۱۰ عنوان بازی با استودیوها و مجموعه‌های داخلی و بین‌المللی را در کارنامه دارد. در حال حاضر، در گلرنگ ونچرز در حوزه توسعه کسب‌وکار فعالیت می‌کند و در شتابدهنده پارالاکس بر رشد بازی‌ها و همراهی تیم‌های بازی‌سازی در مسیر توسعه محصول، ورود به بازارهای بین‌المللی و انتشار جهانی تمرکز دارد.",
  },
];
