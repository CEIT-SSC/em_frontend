...
const TextField = ({ label, id, name, type = "text", errorText, guidance, placeholder = "", }) => {
    return (<div className="w-full">
      <fieldset className="relative rounded-xl p-px border-[#4F5154] border-1 group focus-within:border-white">
        ...
        <input className="w-full h-full pt-1 pb-3 px-4 rounded-xl caret-[#CB48B7] focus-visible:outline-none" id={id} name={name} type={type} placeholder={placeholder}/>
      </fieldset>
