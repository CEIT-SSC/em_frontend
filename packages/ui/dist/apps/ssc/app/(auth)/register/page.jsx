...
var page = function () {
    return (<>
      ...
      <p className="text-[20px]/[150%] font-bold">
        ...
        <link_1.default className="default-gradient text-transparent bg-clip-text" href="/login">
          وارد شوید
        </link_1.default>
      </p>
      <ui_1.TextField name="alaki" id="a" label="نام کاربری" placeholder="نام کاربری خود را وارد کنید"/>
      <ui_1.TextField name="alaki" id="a" label="ایمیل" placeholder="ایمیل خود را وارد کنید"/>
      ...
      <ui_1.TextField name="alaki" id="b" label="تکرار رمز عبور" guidance="تکرار رمز عبور باید شامل حروف بزرگ، حروف کوچک و عدد باشد" placeholder="رمز عبور خود را تکرار کنید"/>
      <div className="flex flex-col items-center py-6 px-9 gap-2.5">
        <div className="w-100.5 flex flex-col items-center gap-2.5">
          <ui_1.Button className="w-100" variant={ui_1.ButtonVariant.PRIMARY} label="ثبت نام"/>
        </div>
      </div>
    </>);
};
